...
- [anthropics/claude-code-action（GitHub 公式・L3 PR Action）](https://github.com/anthropics/claude-code-action)
- [anthropics/claude-code-base-action（GitHub 公式・L2 Base Action）](https://github.com/anthropics/claude-code-base-action)
...
- 解説動画: Anthropic Sid Bidasaria（Claude Code Engineering Lead）による 30 分公式動画（2026 年）
