...
## アルトマン式ソロ創業戦略 10 原則 (2026-05-14 更新): AI 1 人チーム / エージェント管理 CEO スキル / 垂直特化 / GDP インパクト評価 / 実践 5 件 / データアクセス攻めた緩さ / AI 採用遅延の戦略損失 / アイデアマンの逆襲 / 現実主義スタンス / 資本主義再設計議論への対応（労働 vs 資本パワーバランス崩壊）。詳細: [`references/consulting-playbook-altman-solopreneur.md`](references/consulting-playbook-altman-solopreneur.md)
...
## VC ホットトレンド vs 大成功創業年パターン 3 原則 (2026-05-14): 2013-2022 年 10 年データで「ホットテーマと一致しない企業」が真の大成功（Canva / Notion / OpenAI / Anduril / Vanta / Deel / Wiz / Anthropic / Perplexity 等）。原則: ホットトレンドの罠（コンセンサス参入 = コモディティ化）/ 隣接未開拓領域発見 / 構造的賭け前提受容。ConsultingOS は 5 軸コンセンサス外 = 大成功 10 社と同パターン。詳細: [`references/consulting-playbook-vc-counter-trend.md`](references/consulting-playbook-vc-counter-trend.md)
## AI エージェントガードレール 3 層体系 (2026-05-14): 外部パートナー側支出上限 / 自社内ゲートキーパー / 個人レベル（トークン予算 + mid-turn correction）。Digiday + 米国予算事故経験 + ユーザー Claude Code 実体験。Tom Griffiths 8 条件 + Karpathy 12 ルール + 責任設計を統合。詳細: [`references/consulting-playbook-ai-agent-guardrails.md`](references/consulting-playbook-ai-agent-guardrails.md)
---
## 補助セクション（references/ 分離、ハードルール 13、2026-05-05 PR #49）: 銀行審査部 3 共通点（野村幸司）/ 新規事業責任者（佐藤裕介）/ Dorsey 削除設計 / 孫正義「登りたい山」/ Jensen Huang「倒産 30 日前」/ 4 思想兼務運用順序 / マスク式 4 原則。詳細: [`references/consulting-playbook-thoughts.md`](references/consulting-playbook-thoughts.md) / [`references/consulting-playbook-musk-incentive.md`](references/consulting-playbook-musk-incentive.md)
## 出典: FACT = ConsultingOS 規律ファイル (PR #65) / INFERENCE = 佐藤裕介 + Boris Cherny 9 規律派生 / SPECULATION = 4 週間ごと再評価で形骸化検出
