...
| ②プロジェクトフィー | **100万円**（着手前一括） | 関根さんver OS の構築（Phase 1、進化版OS） |
| ③ランニング | **月15万円**（工数上限 月8h） | OS の品質維持・継続進化（反証モード／evolution-log メンテ） |
| ④成果報酬（通常受注） | **売上の5%**（24ヶ月） | 契約後新規受注分 |
| ④成果報酬（OS再販） | **売上の15%**（24ヶ月） | OS自体の再販・OEM時 |

**Light プラン**（月商感覚が小さい場合）：プロジェクト 75万 / ランニング月12万。

**初年度の N.Y.CRAFT 負担見込み**（標準プラン）：約 **390万円**（プロジェクト100万 + ランニング180万 + 業務委託60万 + 成果報酬50万）
**初年度の自分の受取見込み**：約 **390万円** / 工数 約211時間 / **時給換算 約1.85万円** → 副業として成立
