...
## VC ホットトレンド vs 大成功創業年パターン 3 原則 (2026-05-14): 2013-2022 年 10 年データで「ホットテーマと一致しない企業」が真の大成功。原則: ホットトレンドの罠 / 隣接未開拓領域発見 / 構造的賭け前提受容。ConsultingOS は 5 軸コンセンサス外 = 大成功 10 社と同パターン。詳細: [`references/consulting-playbook-vc-counter-trend.md`](references/consulting-playbook-vc-counter-trend.md)
## AI エージェントガードレール 3 層体系 (2026-05-14): 外部パートナー側支出上限 / 自社内ゲートキーパー / 個人レベル（トークン予算 + mid-turn correction）。Tom Griffiths 8 条件 + Karpathy 12 ルール + 責任設計を統合。詳細: [`references/consulting-playbook-ai-agent-guardrails.md`](references/consulting-playbook-ai-agent-guardrails.md)
