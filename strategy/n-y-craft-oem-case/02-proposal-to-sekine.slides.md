...
footer: "2026.04 | Confidential | v5"
lang: ja
style: |
...
↓<br>
<strong>1 案件あたり関根さんの時間は半日に短縮</strong>

<div class="small accent">並行できる案件数が構造的に拡大</div>
</div>
</div>

<blockquote class="small">
関根さんの「中小企業の課題解決をより多くへ展開したい」という願いを、量産可能な構造で実現する
</blockquote>
...
|---|---|
| プロジェクトフィーを<strong>標準価格から大幅圧縮</strong>（標準 100 万級 → 50 万） | N.Y.CRAFT 名出しでの事例公開 |
|  | 構築プロセス・成果のケーススタディ化 |
