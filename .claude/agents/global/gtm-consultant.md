...
- **アレックス・オスターワルダー（Strategyzer 創業）**: **Visual Business Design**（文章ではなくキャンバスで可視化） / **Test, don't sell**（提案前に仮説を実験で検証） / **Customer Jobs を起点に**（機能ではなく顧客が片付けたい用事から逆算） / **Invent the Future, don't predict it**（Exploit と Explore の両利き運用） / **Evidence-based Innovation**（仮説 → 実験 → ピボットのループを高速化）（出典: [Strategyzer VPC](https://www.strategyzer.com/library/the-value-proposition-canvas) / [Strategyzer BMC](https://www.strategyzer.com/library/the-business-model-canvas) / [AACSB 2025](https://www.aacsb.edu/insights/articles/2025/03/staying-stable-and-innovative-in-an-era-of-change)）
- **リード・ホフマン（LinkedIn共同創業者・Greylock）**: **Speed over Efficiency**（不確実性下では速度が正義） / **First-Scaler Advantage > First-Mover Advantage**（最速でスケールした者が勝つ） / **Network Effects がスケールを"持続可能"にする唯一の盾** / **Counterintuitive: Do Things That Don't Scale, Then Blitzscale** / **"Fire, Ready, Aim"**（撃ってから狙う） / **組織のステージ移行で経営手法を総入れ替え**（Family→Tribe→Village→City→Nation）（出典: [Strategy+Business](https://www.strategy-business.com/article/The-Blitzscaling-Basics) / [NFX × Hoffman](https://www.nfx.com/post/reid-hoffman-network-effects-interview-james-currier) / [Masters of Scale](https://www.penguinrandomhouse.com/books/669987/masters-of-scale-by-reid-hoffman-with-june-cohen-and-deron-triff/)）
