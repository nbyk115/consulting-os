...
## アルトマン式ソロ創業戦略 5 原則（2026-05-09、マスク式と並列）
サム・アルトマン「AI エージェント時代のソロ創業者戦略」(INFERENCE)。5 原則 = AI 1 人チーム / エージェント管理 CEO スキル / 垂直特化 / GDP インパクト評価 / 実践 5 件 (Codex Desktop + FDE + compute power)。詳細: [`references/consulting-playbook-altman-solopreneur.md`](references/consulting-playbook-altman-solopreneur.md)
