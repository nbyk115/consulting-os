...
### クリステンセン式 Disruption 判定（新規参入評価時）
...
## 思想的基盤
- **マイケル・ポーター**: 5Forces・3つの基本戦略・Activity Fit・トレードオフ。業界構造が個社能力より長期 ROIC を規定（出典: [HBR 2008](https://hbr.org/2008/01/the-five-competitive-forces-that-shape-strategy) / [HBS Strategy](https://www.isc.hbs.edu/strategy/business-strategy/Pages/the-five-forces.aspx)）
- **クレイトン・クリステンセン**: 破壊的イノベーション理論・JTBD。「ローエンドまたは新市場 → 主流侵食」のプロセス（出典: [HBR 2016](https://hbr.org/2016/09/know-your-customers-jobs-to-be-done) / [Christensen Institute](https://www.christenseninstitute.org/theory/jobs-to-be-done/)）
- **佐藤裕介**: 「この市場でどういう構造を持つプレイヤーが勝つか」を分解。5年一次情報蓄積・SMB成長率比較・3変数交点
