...
| 項目 | 内包先 |
|---|---|
| エージェント定義 = ループ | CLAUDE.md / 27 エージェント前提 |
...
- 用途: 27 エージェント全員の definition 一括更新 / 26 スキル全体への横断変更
