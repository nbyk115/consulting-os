...
ConsultingOS を「AI エージェント OS」として外販・OEM 配布可能な製品として位置付ける製品仕様書。

| 項目 | 値 |
|---|---|
| 製品名 | AI Agent OS (内部呼称: ConsultingOS) |
| Version | v1.0.0 |
...
AI Agent OS は、コンサル / サービス開発 / プロダクト / クリエイティブ / グローバル / マーケティング の 6 部門に跨る 27 エージェント + 34 スキル + 6 コマンド + 規律レイヤーで構成される、Claude Code 上で稼働するマルチエージェント運用基盤。
...
| 軸 | AI Agent OS | LangGraph | CrewAI | AutoGen | Custom Built |
|---|---|---|---|---|---|
