...
# 出典: brand-guidelines.md §日本語字形検知方法（OS ハードルール10準拠）
#
# 使い方: cd strategy/n-y-craft-oem-case && ./generate.sh
...
SOURCE="02-proposal-to-sekine.slides.md"
HTML="02-proposal-to-sekine.html"
PDF="02-proposal-to-sekine.pdf"
PPTX="02-proposal-to-sekine.pptx"
