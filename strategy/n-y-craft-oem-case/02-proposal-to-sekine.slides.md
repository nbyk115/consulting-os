...
footer: "2026.05 | Confidential | v9"
lang: ja
style: |
  ...
  h1 {
    font-family: "Noto Serif JP", "Noto Serif CJK JP", "Yu Mincho", "游明朝", "Hiragino Mincho ProN", "ヒラギノ明朝 ProN", serif;
    color: #0A0A0A;
...
## PMF 期スタートアップ・新規事業の構造的課題

「<strong>スペシャリストを集めたが、チームとして機能しない</strong>」マネジメント不在<br>
<span class="small">N.Y.CRAFT 自身が指摘している創業者の典型的躓き</span>

監督（ディレクター）の<strong>判断・規律が属人化</strong><br>
<span class="small">監督が抜けると組織として機能しなくなる脆弱性</span>

「売れる仕組み」を<strong>移植・再現できない</strong><br>
<span class="small">案件ごとにゼロから組み立て、ナレッジが個人に滞留</span>
...
<span class="small">監督の判断・チームの連携・品質保証は範囲外</span>

「事業 OS」レイヤーは<span class="accent">市場の空白</span><br>
<span class="small">単発回答ではなく、TEAM CRAFT 型の役割分担を構造化する基盤が必要</span>

求められるもの:<br>
<strong>監督の判断 × メンバーの連携 × 品質保証を再現するオペレーション基盤</strong>

</div>
</div>

<blockquote class="small" style="margin-top:14px;">
PMF 期の事業継続性 ＝ 監督の判断の脱属人化 × チーム機能の標準化 ＝ AI エージェント OS が解く構造的課題
</blockquote>
