...
footer: "2026.04 | Confidential | v4"
lang: ja
style: |
...
OS の手順・テンプレ・反証チェックを参照<br>
↓<br>
失敗パターンは学習ログに蓄積済み<br>
<span class="small neutral">（evolution-log：規律違反・修正履歴の永続記録）</span><br>
↓<br>
<strong>OS が育成コーチ役を兼ねる</strong><br>
↓<br>
...
<blockquote class="small">
新人が早く立ち上がる ＝ 受注可能案件数が構造的に増える。属人化解消は事業継続性そのもの。
</blockquote>
...
| ランニング 15万×12 | 180 万 |
| 業務委託 5万×12 | 60 万 |
| ベース合計 | <strong>340 万円</strong> |

<span class="small">＋ 成果報酬（売上連動）</span>
...
Phase 1 スコープ縮小（業界プレイブック新設・中堅中小企業特化を Phase 2 送り）
...
このプロジェクトを <span class="accent">ConsultingOS の他社展開における第 1 事例</span> として位置付けさせてください

| こちらが提供する圧縮 | 関根さん側にお願いする協力 |
|---|---|
| プロジェクトフィー <strong>65 万円分の圧縮</strong>（標準 165 万 → 100 万） | N.Y.CRAFT 名出しでの事例公開 |
|  | 構築プロセス・成果のケーススタディ化 |
|  | 他社展開時の参考事例として紹介する協力（年 2 回まで） |
