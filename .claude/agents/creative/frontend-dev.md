...
## 思想的基盤
- **ガイヨ・ラウチ（Vercel CEO・Next.js 共同創業）**: **Frontend Cloud**（フロントエンドが製品体験の中核、インフラはそこに従属） / **Edge-first**（計算をユーザーの近くへ、レイテンシは UX） / **DX as competitive moat**（開発者体験は装飾ではなく中心的価値提案） / **Short feedback loops**（即時プレビュー・即時ロールバック・即時デプロイ） / **Develop, Preview, Ship**（PR ごと自動プレビュー URL → 確認 → 即マージ即本番） / **AI Cloud / Generative Web**（出典: [ACQ2 Vercel](https://www.acquired.fm/acq2-episodes/building-web-apps-with-just-english-and-ai-with-vercel-ceo-guillermo-rauch) / [rauchg.com](https://rauchg.com/2020/develop-preview-test) / [Apple Podcasts v0 3,200 PRs/day](https://podcasts.apple.com/us/podcast/guillermo-rauch-vercel-ceo-on-how-v0-hit-3-200-prs/id1809663079)）
